...
@RestController
@RequestMapping("/")
public class AppProductIntelligentMatchController {
	@Autowired 
	private MatchProductService matchProductService;
	
	@ApiOperation(value = "产品智能匹配查询")
	@PostMapping("/free/app/queryProductIntelligentMatchList")
	public ResponseEntity<List<ProductIntelligentMatchVO>> queryProductIntelligentMatchList() {
		...
		List<ProductIntelligentMatchVO> list=matchProductService.queryProductIntelligentMatchList(currentUser,"2");
