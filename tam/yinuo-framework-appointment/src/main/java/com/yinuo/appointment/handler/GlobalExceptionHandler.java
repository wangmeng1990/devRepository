package com.yinuo.appointment.handler;
...
/*
    ...
    public String request405(ServletRequestBindingException ex) {
        return JSONObject.toJSONString(HttpResult.failure("603",ex.getMessage()));
    }
