...
public class LogRecodePostFilter extends ZuulFilter {
    ...
    public Object run() {
        try {
            ...
            logger.info("请求方法method={},url={},token:={}",method,interfaceMethod,token);
                ...
                if (reqBody != null) {
                    ...
                    if (conType.contains("multipart/form-data") || conType.contains("application/json")) {
                        if (conType.contains("multipart/form-data")) {
                            reqBody = formDateToJson(reqBody);
                        }
    ...
    public  String formDateToJson(String param){
